				...
				<div class="card-body">
					<form action="{{ route('sub-category.update', $SubCategory->id) }}" method="POST" enctype="multipart/form-data">
						...
						<div class="mb-3">
							...
							<input type="name" name="name" class="form-control" id="name" value="{{ $SubCategory->name }}">
						...
						<div class="mb-3">
							...
							<input type="slug" name="slug" class="form-control" id="slug" value="{{ $SubCategory->slug }}">
							@if($errors->has('slug'))
