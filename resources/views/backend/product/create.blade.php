...
<div class="container-fluid">
	<div class="card">
		<div class="card-body">
			<h5 class="card-title fw-semibold mb-4">Fill this field for add new product.</h5>
			<div class="card">
				<div class="card-body">
					<form action="{{ route('product.store') }}" method="POST" enctype="multipart/form-data">
						...
						<div class="row">
							<div class="mb-5 col-lg-6">
								<label for="sub_category_id" class="form-label">Sub Category <span style="color:red">*</span></label>
							...
							<div class="mb-5 col-lg-6">
								...
								<input type="off_price" name="off_price" class="form-control" id="off_price">
						...
						<div class="row">
							<div class="mb-5 col-lg-6">
								<label for="current_price" class="form-label">Current Price <span style="color:red">*</span></label>
								<input type="current_price" name="current_price" class="form-control" id="current_price">
							...
							<div class="mb-5 col-lg-6">
								...
								<input type="normal_price" name="normal_price" class="form-control" id="normal_price">
						...
						<div class="row">
							<div class="mb-5 col-lg-3">
								<label for="image1" class="form-label">Image 1 <span style="color:red">*</span></label>
							...
							<div class="mb-5 col-lg-3">
								<label for="image2" class="form-label">Image 2 <span style="color:red">*</span></label>
						...
						<div class="mb-5 col-lg-12">
							<label for="information" class="form-label">Product Information <span style="color:red">*</span></label>
							<textarea rows="10" cols="30" type="information" name="information" class="summernote" id="information"></textarea>
							<div class="form-text">Product Information field is not required for every product.</div>
						...
						<div class="mb-5 col-lg-12">
							<label for="details" class="form-label">Product Description <span style="color:red">*</span></label>
							<textarea rows="10" cols="30" type="details" name="details" class="summernote" id="details"></textarea>
