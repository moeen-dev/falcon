...
<body class="bg-light">
    <div class="container">
        <div class="py-5 text-center">
            <h2 style="color:red;">Fill out this form for confirm your order!</h2>
                ...
                <ul class="list-group mb-3">
                    ...
                    <li class="list-group-item d-flex justify-content-between lh-condensed">
                        <div>
                            ...
                            <small class="text-muted">{{ $unitPrice }} x {{ $cart->quantity }}</small>
                        </div>
            ...
            <div class="col-md-6 order-md-1">
                ...
                <form method="POST" class="needs-validation" novalidate>
                    ...
                    <div class="mb-3">
                        ...
                        value="{{ $user->shipping_address }}" required>
                        <div class="invalid-feedback">
                    ...
                    <div class="mb-3">
                        <label for="address2">Address 2 <span class="text-muted">Billing Address</span></label>
                        <input type="text" class="form-control" id="address2" placeholder="Apartment or suite" value="{{ $user->billing_address }}">
                    </div>
