                ...
                <div class="item left styled">
                    ...
                    <form method="POST" action="{{ route('user.register.submit')}}">
                        ...
                        <div class="primary-checkout">
                            <button class="primary-button primary-checkout">Sign Up</button>
                        </div>
                    </form>
                </div>
                ...
                <div class="item right">
                    ...
                    <div class="summary-order is-sticky">
                        <div class="summary-totals">
                            <p>If you have already an account please login by clicking <strong><a style="color: red;" href="{{ route('user.login')}}">Create An Account?</a></strong>.</p>
                        </div>
